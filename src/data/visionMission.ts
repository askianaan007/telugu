...
export function getVisionParagraphLocalProgress(visionProgress: number, paragraphIndex: number): number {
...
export function getMissionBulletLocalProgress(missionProgress: number, bulletIndex: number): number {
...
export const VISION_MISSION_IMAGES = {
  vision:  { src: '/images/our-vision.png',   alt: 'Telugu Airlines vision — premium helicopter charter' },
  mission: { src: '/images/our-mission.png',  alt: 'Helicopter flying between modern skyscrapers viewed from below' },
  bullet:  { src: '/images/gradient-gold-circle.png', alt: '' },
} as const