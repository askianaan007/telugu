        ...
        (_, contextSafe) => {
            ...
            const ctx = gsap.context(() => {
                ...
                gsap.timeline({ scrollTrigger: { trigger: root, start: 'top 80%', once: true, invalidateOnRefresh: true } })
                    ...
                    .to(headerBits, { y: 0, autoAlpha: 1, filter: 'blur(0px)', duration: 1.05, stagger: 0.1, ease: gsapEasings.smooth }, 0.05)
                    ...
                    .to(bottom, { y: 0, autoAlpha: 1, filter: 'blur(0px)', duration: 0.95, ease: gsapEasings.smooth }, 0.78)
            }, root)
