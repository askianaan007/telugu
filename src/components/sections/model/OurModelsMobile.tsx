...
export function OurModelsMobile() {
    ...
    return (
        ...
        >
            <div className="relative w-full">
                ...
                <div className="relative z-10 flex min-h-svh w-full flex-col max-lg:min-h-0">
                    <OurModelsFixedBackdrop ambientMotion={!reduceMotion} />
                    <div className="max-w-base relative z-20 mx-auto w-full px-4 sm:px-6">
