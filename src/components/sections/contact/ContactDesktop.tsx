...
export function ContactDesktop() {
    ...
    useGSAP(
        () => {
            ...
            const tl = gsap.timeline({
                scrollTrigger: { trigger: root, start: 'top 88%', end: '+=130%', scrub: 0.88, invalidateOnRefresh: true },
            })
    ...
    return (
        <Section id="contact" ref={sectionRef} variant="default" paddingY="none" className="bg-brand-surface relative overflow-hidden pb-20 sm:pb-24 lg:pb-28">
            <ContactBg />
