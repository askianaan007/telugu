    ...
    return (
        <Section variant="default" paddingY="xl" className="bg-brand-surface">
            ...
            <style dangerouslySetInnerHTML={{
                __html: `
                .why-choose-path-pulse {
                    stroke-dasharray: 0.18 0.82;
                    stroke-dashoffset: 1;
                    animation: whyChoosePulse 2.8s linear infinite;
                }
                ...
                .why-choose-arrival-core {
                    animation: whyChooseArrivalCore 2.8s linear infinite;
                }
                @keyframes whyChooseArrivalCore {
                    0%, 85%  { opacity: 0; r: 2.4px; }
                    90%      { opacity: 1; r: 3.6px; }
                    100%     { opacity: 0; r: 2.4px; }
                }
                .why-choose-arrival-ring {
                    animation: whyChooseArrivalRing 2.8s linear infinite;
                }
                @keyframes whyChooseArrivalRing {
                    0%, 85%  { opacity: 0; r: 2.4px; }
                    90%      { opacity: 0.65; r: 6px; }
                    100%     { opacity: 0; r: 9px; }
                }
            ` }} />
        </Section>
