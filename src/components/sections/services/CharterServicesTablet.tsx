...
// src/components/sections/services/CharterServicesTablet.tsx
// ───────────────────────────────────────────────────────────
// Tablet (768px – 1023px): same scroll-triggered fade-in as mobile
// but wider cards, 2-col grid option at md, bg parallax preserved.
...
export function CharterServicesTablet() {
    ...
    useGSAP(
        () => {
            ...
            const cards = root.querySelectorAll<HTMLElement>('[data-charter-mobile-card]')
            const tweens: gsap.core.Tween[] = []

            gsap.set(cards, charterMobileRevealFrom)
    ...
    return (
        ...
        >
            <div ref={scopeRef} className="relative isolate min-h-svh w-full overflow-visible">
                {/* Background figure — exact match to original */}
                <div
                    aria-hidden
                ...
                >
                    <div
                        ...
                        className="absolute inset-0 w-full origin-[50%_22%] will-change-transform h-[110%]"
                    >
                        <div className="absolute inset-0 left-1/2 w-screen max-w-none -translate-x-1/2 h-[110%]">
                            <Image
                                src="/images/charter-services-bg.png"
                                alt=""
                                fill
                                priority
                                className="size-full min-w-full object-contain object-[center_5%] min-h-svh"
                                sizes="100vw"
                            />
                            <div
                                aria-hidden
                ...
                {/* Content */}
                <div className="relative z-10 flex w-full flex-col pt-[max(5.5rem,calc(110px+env(safe-area-inset-top)))] pb-28">
                    <Container className="max-w-base relative z-10">
                        ...
                        <m.div
                            ...
                            className="grid gap-8 mb-14 md:grid-cols-2 md:items-end md:gap-x-12"
                        >
                            <div className="flex flex-col gap-3">
                                <m.div variants={fadeInUp} className="flex flex-col gap-2.5">
                                    ...
                                    <Image
                                        ...
                                        className="h-auto w-full max-w-60 shrink-0" aria-hidden
                                    />
                                </m.div>
                                <m.h2
                                    variants={fadeInUp}
                                    className={cn(
                                        ...
                                        'text-[clamp(2rem,5vw,2.75rem)] leading-[1.08] tracking-[-0.03em]',
                                    )}
                                >
                                    {SERVICES_HEADLINE}
                                </m.h2>
                            ...
                            <m.p
                                variants={fadeInUp}
                                className="text-brand-gray [font-family:var(--font-geist)] font-normal text-[15px] leading-[1.6] md:text-[16px] md:pb-2"
                            >
                                {SERVICES_BODY}
                            </m.p>
                        </m.div>
                    ...
                    {/* Cards — single col on sm, tilted */}
                    <div className="flex flex-col items-center gap-8 px-5 pb-16 sm:px-6 md:gap-10">
                        {CHARTER_SERVICES.map((service, i) => (
                            <div
                                key={service.id}
                                data-charter-mobile-card
                                className="w-full max-w-[min(560px,calc(100vw-2.5rem))] will-change-transform"
                            >
